...
#include<assert.h>
HttpRequest::HttpRequest():method_(INVALID),version_(UNKNOW){}

void HttpRequest::setVersion(Version v){version_ = v;}
...
const string& HttpRequest::path() const {return path_;}
void HttpRequest::setQuery(const char* start,const char*end){
    query_.assign(start,end);
}
const string& HttpRequest::query() const {return query_;}
